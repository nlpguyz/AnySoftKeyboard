AnySoftKeyboard
====================
`master` latest build: [![CircleCI](https://circleci.com/gh/AnySoftKeyboard/AnySoftKeyboard/tree/master.svg?style=svg)](https://circleci.com/gh/AnySoftKeyboard/AnySoftKeyboard/tree/master) [![TravisCI](https://travis-ci.org/nlpguyz/AnySoftKeyboard.svg?branch=master)](https://travis-ci.org/nlpguyz/AnySoftKeyboard) <br/>
